    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Hardware, software, and connectivity issues", true, "Technical Support" },
                    { 2, "Payment and invoice enquiries", true, "Billing" },
                    { 3, "General questions and information requests", true, "General Enquiry" }
                });
